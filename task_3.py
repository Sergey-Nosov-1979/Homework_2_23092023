...
frac1_str = input("Введите первую дробь вида a/b - ")
frac2_str = input("Введите вторую дробь вида a/b - ")
...
print(f"Произведение дробей {frac1_str} и {frac2_str} результат = {prod_frac[0]}/{prod_frac[1]}")
